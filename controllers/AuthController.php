...
class AuthController // Controlador para manejar las operaciones de autenticación.
{
    ...
    public function __construct(PDO $conexion) // Ahora tipado para indicar que espera un objeto PDO
    {
        $this->db = $conexion;
        $this->userModel = new User($conexion); // Pasa la conexión al constructor de User
    }
...
public function sendResetEmail()
{
    ...
    try {
        ...
        // Envía el correo
        $mailer->send($email, $user['nombre'], $subject, $body);
